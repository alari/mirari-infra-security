...
class MirariInfraSecurityGrailsPlugin {
    // the plugin version
    def version = "0.1.5"
    ...
    def title = "Mirari Infra Security Plugin" // Headline display name of the plugin
...
'''
    ...
    def documentation = "http://grails.org/plugin/mirari-infra-security"
